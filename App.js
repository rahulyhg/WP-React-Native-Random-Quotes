...
export default class LeadershipCards extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      isLoading: true 
  ...
  getInitialState() {
    return {
      // card is initially set to null so that loading message shows
      card: null,
      cardIds: null,
      currentID: null
    };
  ...
  // This is the magic happens. Fetches the data from the API & updates application state
  fetchData() {
    ...
    return(
      <View style={styles.container}>
        ...
        <View style={styles.buttonContainer}>
          <TouchableHighlight style={styles.button} underlayColor='#ccc' onPress={this.fetchData}>
